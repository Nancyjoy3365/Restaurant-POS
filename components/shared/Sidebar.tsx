...
export function Sidebar() {
  ...
  return (
    <>
      <nav className="hidden lg:flex flex-col w-64 shrink-0 h-screen border-r border-warm-200 bg-white">
        ...
        <div className="flex-1 min-h-0 overflow-y-auto py-4 px-3 space-y-2">
