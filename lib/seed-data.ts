...
export const seedMenu: MenuItem[] = [
  // Main
  { id: "mn1", name: "Fish (Dry)", aliases: ["fish"], category: "Main", price: 350, veg: false, available: true, variantGroup: "Fish", variantLabel: "Dry" },
  { id: "mn2", name: "Fish (Wet)", aliases: ["fish"], category: "Main", price: 350, veg: false, available: true, variantGroup: "Fish", variantLabel: "Wet" },
  { id: "mn3", name: "Fish (Boiled)", aliases: ["fish"], category: "Main", price: 400, veg: false, available: true, variantGroup: "Fish", variantLabel: "Boiled" },
  { id: "mn4", name: "Fish (Wet Special)", aliases: ["fish"], category: "Main", price: 400, veg: false, available: true, variantGroup: "Fish", variantLabel: "Wet Special" },
  { id: "mn5", name: "Fish (Dry Special)", aliases: ["fish"], category: "Main", price: 450, veg: false, available: true, variantGroup: "Fish", variantLabel: "Dry Special" },
  { id: "mn6", name: "Fish (Coconut)", aliases: ["fish", "coconut fish"], category: "Main", price: 500, veg: false, available: true, variantGroup: "Fish", variantLabel: "Coconut" },
